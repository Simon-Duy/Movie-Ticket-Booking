...
namespace CINEMA.frmAdminUserControls.DataUserControl
{
    public partial class TicketsUC : UserControl
    {
        ...
        private void btnAddTicketsByShowTime_Click_1(object sender, EventArgs e)
        {
            if (lsvAllListShowTimes.SelectedItems.Count > 0)
            {
                ShowTimes showTimes = lsvAllListShowTimes.SelectedItems[0].Tag as ShowTimes;
        ...
        private void btnDeleteTicketsByShowTime_Click_1(object sender, EventArgs e)
        {
        ...
        private void btnShowShowTimeNotCreateTickets_Click_1(object sender, EventArgs e)
        {
        ...
        private void btnShowAllTicketsBoughtByShowTime_Click_1(object sender, EventArgs e)
        {
            if (lsvAllListShowTimes.SelectedItems.Count > 0)
            {
                ShowTimes showTimes = lsvAllListShowTimes.SelectedItems[0].Tag as ShowTimes;
